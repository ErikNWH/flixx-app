...
async function displayMovieDetails() {
  ...
  // Overlay for background image movies
...
async function displayShowDetails() {
  ...
  <div class="details-bottom">
    ...
    <ul>
      ...
      <li><span class="text-secondary">Episode Runtime:</span> ${show.episode_run_time.length ? show.episode_run_time[0] : 'N/A'} minutes</li>
      <li><span class="text-secondary">Last air date</span> ${show.last_air_date}</li>
      <li><span class="text-secondary">Latest episode</span> ${show.last_episode_to_air.name}</li>
